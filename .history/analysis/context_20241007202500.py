def context_plot(file_path):
    ...
    plt.tight_layout()
    plt.savefig(file_path[:-4] + '_context.png', dpi=300)
    
    # print(df_sorted)
    # plt.figure(figsize=(10, 6))
    # sns.barplot(x=df_sorted['context'], y=df_sorted['con_mean'], data=site_df, ci=None)
    # plt.xlabel('Context')
    # plt.ylabel('Mean Value')
    # plt.title(f'Mean Values of Different Contexts for Site')
    # plt.xticks(rotation=45)
    # plt.tight_layout()
    
if __name__ == '__main__':
    file_path = './get_plots/site_HEK293T_ABE.csv'
